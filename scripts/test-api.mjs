...
const base = { 'content-type': 'application/json', host: 'nsacleaningllc.com', origin: 'https://nsacleaningllc.com' };
...
r = await handleQuote({ method: 'POST', headers: { 'content-type': 'application/x-www-form-urlencoded', host: 'nsacleaningllc.com' }, ip: '2.2.2.2', bodyText: 'name=Jo&email=x&_ts=' + fresh(), env: {} });
...
let res = fakeRes();
await vercelHandler({ method: 'POST', headers: { 'content-type': 'application/x-www-form-urlencoded', host: 'nsacleaningllc.com' }, socket: {}, body: { name: 'Jo', email: 'x', _ts: String(fresh()) } }, res);
...
res = fakeRes();
await vercelHandler({ method: 'POST', headers: { 'content-type': 'application/json', host: 'nsacleaningllc.com' }, socket: {}, body: { name: 'Jo', email: 'x', _ts: fresh() } }, res);
